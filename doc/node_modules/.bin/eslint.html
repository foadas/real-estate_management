...
<p><code>eslint --init</code> has been moved to <code>@eslint/create-config</code></p>
        ...
        <td class="code highlight">
          <pre class="javascript">        <span class="hljs-built_in">console</span>.warn(<span class="hljs-string">"You can also run this command directly using 'npm init @eslint/config'."</span>);

        <span class="hljs-keyword">const</span> spawn = <span class="hljs-built_in">require</span>(<span class="hljs-string">"cross-spawn"</span>);

        spawn.sync(<span class="hljs-string">"npm"</span>, [<span class="hljs-string">"init"</span>, <span class="hljs-string">"@eslint/config"</span>], { <span class="hljs-attr">encoding</span>: <span class="hljs-string">"utf8"</span>, <span class="hljs-attr">stdio</span>: <span class="hljs-string">"inherit"</span> });
